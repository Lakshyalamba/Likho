    ...
    <div className="min-h-screen bg-[#f6f5f2] text-slate-950 dark:bg-slate-950 dark:text-slate-50">
      ...
      >
        ...
        <div className="mt-auto relative">
          ...
          >
            ...
            {isSidebarOpen ? (
              <svg className={`h-4 w-4 shrink-0 text-slate-400 transition ${showProfileMenu ? "rotate-180" : ""}`} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2} aria-hidden="true">
          ...
          {showProfileMenu && isSidebarOpen ? (
            <div
              className="absolute bottom-full left-0 right-0 mb-2 rounded-xl border border-white/20 bg-white/80 p-2 shadow-xl backdrop-blur-2xl dark:border-white/10 dark:bg-slate-900/80"
              role="menu"
            >
      ...
      >
        ...
        <button
          type="button"
          onClick={toggleTheme}
          className="flex h-8 w-8 items-center justify-center rounded-lg border border-white/20 bg-white/50 text-slate-600 shadow-sm backdrop-blur transition hover:bg-white/80 hover:text-slate-950 dark:border-white/10 dark:bg-slate-800/30 dark:text-slate-400 dark:hover:bg-slate-800/60 dark:hover:text-white"
